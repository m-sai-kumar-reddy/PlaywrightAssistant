...
export function VerificationModal({ isOpen, onClose, onOpenTab, onSkip }: VerificationModalProps) {
  return (
      ...
      <DialogContent className="max-w-md">
        ...
        <div className="space-y-4">
          <p className="text-gray-600 dark:text-gray-400">
            A human verification challenge has been detected. A new browser tab will open for you to complete the verification manually.
          </p>
